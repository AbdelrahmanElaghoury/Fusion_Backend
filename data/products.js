module.exports = [
  // ------- Original Products --------
  {
    ...
    concerns: ["Hyperpigmentation","Melasma","Acne","Wrinkles","Redness","Uneven Skin Tone"],
  ...
  {
    id: 15,
    name: "Cooling Relief Gel - Menopause Comfort",
    description: "A soothing over-the-counter gel designed to provide immediate cooling relief from hot flashes associated with menopause. Infused with menthol, aloe vera, and vitamin E to calm the skin and reduce redness and discomfort.",
    price: 38,
    Type: "OTC",
    imageUrl: "/assets/Fusion_Sample_Product.jpeg",
    ingredients: [
      { name: "Menthol", percentage: "2%" },
      { name: "Aloe Vera", percentage: "" },
      { name: "Vitamin E", percentage: "" },
      { name: "Chamomile Extract", percentage: "" }
    ],
    concerns: [
      "Hot Flashes",
      "Redness",
    ...
    howWhy: "Menthol provides rapid cooling, helping to alleviate the sensation of heat during a hot flash. Aloe vera and chamomile soothe irritation and reduce redness, while vitamin E hydrates and protects the skin. Designed for use on neck, chest, or face during menopause.",
    howToUse: "Apply a thin layer to the skin on the neck, chest, or face during a hot flash. Reapply as needed. Avoid eyes and broken skin.",
    pairsWith: [],
    topIcon: "New",
    sideIcon: "/assets/logo4.png"
  },
  {
    id: 16,
    name: "Migraine Ease Topical Cream",
    description: "A non-prescription cream formulated for rapid relief of migraine headaches. Contains magnesium, peppermint oil, and lavender to ease pain and tension when applied to temples and neck.",
    price: 42,
    Type: "OTC",
    imageUrl: "/assets/Fusion_Sample_Product.jpeg",
    ingredients: [
      { name: "Magnesium Sulfate", percentage: "3%" },
      { name: "Peppermint Oil", percentage: "" },
      { name: "Lavender Oil", percentage: "" },
    ...
    howWhy: "Magnesium calms muscle tension and nerve signals, peppermint and lavender provide cooling and calming effects, and shea butter hydrates sensitive skin. This combination addresses both migraine pain and accompanying discomfort such as scalp sensitivity.",
    howToUse: "Gently massage a small amount into temples, forehead, and back of neck at the onset of a migraine. Avoid eyes and mucous membranes.",
    pairsWith: [],
    topIcon: "Best Seller",
    sideIcon: "/assets/logo4.png"
  },
  {
    ...
    description: "A daily supplement for menopausal women to help reduce hot flashes, support hormonal balance, and improve mood and sleep. Contains black cohosh, soy isoflavones, and vitamin B6.",
    price: 47,
    Type: "OTC",
    imageUrl: "/assets/Fusion_Sample_Product.jpeg",
    ingredients: [
      { name: "Black Cohosh", percentage: "40mg" },
      { name: "Soy Isoflavones", percentage: "80mg" },
      { name: "Vitamin B6", percentage: "2mg" },
      { name: "Magnesium", percentage: "100mg" }
    ],
    concerns: [
      "Hot Flashes",
      "Dryness",
    ...
    howWhy: "Black cohosh and soy isoflavones are phytoestrogens shown to reduce hot flashes and support hormonal balance. Vitamin B6 and magnesium help manage mood swings, sleep quality, and muscular discomfort.",
    howToUse: "Take one capsule daily with food. Consult a healthcare provider before use.",
    pairsWith: [],
    topIcon: "New",
    sideIcon: "/assets/logo4.png"
  },
  {
    id: 18,
    name: "Migraine Preventive Nasal Spray",
    description: "A prescription nasal spray to prevent and reduce the frequency of migraine attacks. Contains sumatriptan for acute migraine management and vitamin B2 for preventive support.",
    price: 60,
    Type: "RX",
    imageUrl: "/assets/Fusion_Sample_Product.jpeg",
    ingredients: [
      { name: "Sumatriptan", percentage: "10mg" },
      { name: "Vitamin B2 (Riboflavin)", percentage: "100mg" }
    ],
    concerns: [
      "Migraine",
      "Pain",
    ...
    howWhy: "Sumatriptan is a proven migraine-specific therapy that constricts blood vessels and blocks pain pathways in the brain. Vitamin B2 has evidence for reducing migraine frequency. Nasal spray offers fast onset for acute attacks.",
    howToUse: "Spray one dose into one nostril at migraine onset. Do not exceed prescribed dose. For prevention, use daily as prescribed.",
    pairsWith: [],
    topIcon: "Most Prescribed",
    sideIcon: "/assets/logo4.png"
  }
